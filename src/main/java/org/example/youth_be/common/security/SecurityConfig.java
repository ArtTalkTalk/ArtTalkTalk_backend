...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        config.addAllowedOrigin("https://youth-frontend-steel.vercel.app");
    ...
    protected SecurityFilterChain filterChain(final HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(antMatcher(HttpMethod.POST, "/users/{userId}/links")).hasAnyRole(String.valueOf(UserRoleEnum.REGULAR), String.valueOf(UserRoleEnum.ASSOCIATE))
                        .requestMatchers(antMatcher(HttpMethod.DELETE, "/users/{userId}/links/{linkId}")).hasAnyRole(String.valueOf(UserRoleEnum.REGULAR), String.valueOf(UserRoleEnum.ASSOCIATE))
                        .requestMatchers(antMatcher(HttpMethod.PUT, "/users/{userId}/links/{linkId}")).hasAnyRole(String.valueOf(UserRoleEnum.REGULAR), String.valueOf(UserRoleEnum.ASSOCIATE))
